...
#define _serverSock_name "sockProva"
...
simpleClientTask2(void * arg)
{
  ...
  _createToOneMessage(toSnd_msg, "dio cane puttana eva");
...
main(int argc, char ** argv)
{
  ...
  for (i=min; i<max+1; i++)
    ...
    case 0:
      ...
      _test("simple test 0", simpleTest(0,    0,    0,   1,    0, 0), es); break;
    case 1:  
      /* client effettua due tentativi prima di connettersi */
      _test("simple test 1", simpleTest(1, 0, 0,  0, 0,  0), es); break;
    case 2:
      /* client effettua tre tentativi prima di connettersi */
      _test("simple test 2", simpleTest(2, 0, 0,  0, 0,  0), es); break;
    case 3:
      /* client non trova il server in attesa */
      _test("simple test 3", simpleTest(3, 0, 0,  0, 0,  0), es); break;
    ...
    case 5:
      ...
      _test("simple test 5", simpleTest(0, 0, 5,  1, 0,  0), es); break;
    case 6:
      /* il server chiude la connessione prima del client */
      _test("simple test 6", simpleTest(0, 0, 0,  1, 5,  0), es); break;      
    case 7:
      _test("simple test 7", simpleTest(0, 0, 0,  1, 3,  1), es); break;
    }
